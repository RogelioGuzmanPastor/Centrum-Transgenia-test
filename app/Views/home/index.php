        ...
        <form action="/test" method="GET">
            <section class="contenido-pasos paso-1 active">
                ...
                <div class="informacion-contacto row p-0 mx-auto justify-content-between">
                    <div class="col-12 col-md-6 mb-sm-5 mb-md-0 row p-0 mx-0">                        
                        <label for="name" class="col-12 col-sm-4 col-md-12 p-0">Name</label>
                        <div class="input-form row col-12 col-sm-8 col-md-12 p-0">
                            <input type="text" id="name" name="name" class="input col-12" placeholder="John Carter">
                    ...
                    <div class="col-12 col-md-6 mb-sm-5 mb-md-0 row p-0 mx-0">                        
                        ...
                        <div class="input-form row col-12 col-sm-8 col-md-12 p-0">
                            <input type="text" id="email" name="email" class="input col-12" placeholder="Email address">
                    ...
                    <div class="col-12 col-md-6 mb-sm-5 mb-md-0 row p-0 mx-0">                        
                        ...
                        <div class="input-form row col-12 col-sm-8 col-md-12 p-0">
                            <input type="text" id="phone" name="phone" class="input col-12" placeholder="(123) 456 - 7690">
                    ...
                    <div class="col-12 col-md-6 mb-sm-5 mb-md-0 row p-0 mx-0">                        
                        ...
                        <div class="input-form row col-12 col-sm-8 col-md-12 p-0">
                            <input type="text" id="company" name="company" class="input col-12" placeholder="John Carter">
            ...
            <section class="contenido-pasos paso-2 ">
                ...
                <div class="servicio-interes row p-0 mx-auto justify-content-between">
                    ...
                    <div class="col-12 col-sm-6 row mx-auto mx-md-0 servicio" data-servicio="Other">                        
                        <div class="icono">
                            <svg width="40" height="42" viewBox="0 0 40 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="20.0274" cy="20.8807" r="8.78843" fill="white"/>
                    ...
                    <input type="hidden" value="Development" name="servicio" id="inputServicio">
                </div>
            </section>
            ...
            <section class="contenido-pasos paso-3">
                ...
                <div class="rango-interes row p-0 mx-auto justify-content-between">
                    <div class="col-12 col-sm-6 row mx-auto mx-md-0 rango active" data-rango="5-10">                        
                        <div class="icono">
                    ...
                    <div class="col-12 col-sm-6 row mx-auto mx-md-0 rango" data-rango="10-20">                        
                        <div class="icono">
                            <div class="interior"></div>
                        </div>
                        <p>$10.000 - $20.000</p>
                    ...
                    <div class="col-12 col-sm-6 row mx-auto mx-md-0 rango" data-rango="20-50">                        
                        <div class="icono">
                            <div class="interior"></div>
                        </div>
                        <p>$20.000 - $50.000</p>
                    ...
                    <div class="col-12 col-sm-6 row mx-auto mx-md-0 rango" data-rango="50+">                        
                        <div class="icono">
                            <div class="interior"></div>
                        </div>
                        <p>$50.000 +</p>
                    ...
                    <input type="hidden" value="5-10" name="rango" id="inputRango">
                </div>
            </section>
            
            <section class="contenido-pasos paso-4 ">
                <div class="ready-image mx-auto text-center">
