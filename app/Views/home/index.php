<main id="home-trasgenia">
    <section class="header">
        <h1>Get a project quote</h1>
        <h2>Please fill the form below to receive a quote for your project. Feel free to add as much detail as needed.</h2>
    </section>
    <section class="contenedor-pasos">
        <div class="progreso">
            ...
            <div class="barra">                
                <div class="relleno" style="width: 50%;"></div>
            </div>
            <div class="numero">
                <span>2</span>
            </div>
        ...
        <form action="" method="POST">
            <section class="contenido-pasos paso-1 active">
                ...
                <div class="informacion-contacto row p-0 mx-auto justify-content-between">
                    <div class="col-12 col-md-6 row p-0 mx-0">                        
                        <label for="name" class="col-12 col-sm-4 col-md-12 p-0">Name</label>
                        <div class="input-form row col-12 col-sm-8 col-md-12 p-0">
                            <input type="text" id="name" class="input col-12" placeholder="John Carter">
                    ...
                    <div class="col-12 col-md-6 row p-0 mx-0">                        
                        <label for="email" class="col-12 col-sm-4 col-md-12 p-0">Email</label>
                        <div class="input-form row col-12 col-sm-8 col-md-12 p-0">
                            <input type="email" id="email" class="input col-12" placeholder="Email address">
                    ...
                    <div class="col-12 col-md-6 row p-0 mx-0">                        
                        <label for="phone" class="col-12 col-sm-4 col-md-12 p-0">Phone Number</label>
                        <div class="input-form row col-12 col-sm-8 col-md-12 p-0">
                            <input type="text" id="phone" class="input col-12" placeholder="(123) 456 - 7690">
                    ...
                    <div class="col-12 col-md-6 row p-0 mx-0">                        
                        <label for="company" class="col-12 col-sm-4 col-md-12 p-0">Company</label>
                        <div class="input-form row col-12 col-sm-8 col-md-12 p-0">
                            <input type="text" id="company" class="input col-12" placeholder="John Carter">
            ...
            <section class="contenido-pasos paso-2">
                <header>
                    <h3>Our services</h3>
                    <h4>Please select which service you are interested in.</h4>
                </header>   
                         
            </section>
            
            <section class="contenido-pasos paso-3">
                <header>
                    <h3>What’s your project budget?</h3>
                    <h4>Please select the project budget range you have in mind.</h4>
                </header>
            </section>
            
            <section class="contenido-pasos paso-4">
                <header>
